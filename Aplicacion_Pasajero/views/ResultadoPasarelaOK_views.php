    ...
    <body>	
		<div class="container" style="font-family: Arial, Helvetica, sans-serif; padding-top: 10rem;">
			<div class="card border-light text-white text-center px-4 py-4 my-4" style="background:rgba(0,0,0,0.8);font-weight: bold;">
				<h1 class="display-4 text-white pt-2">SE HA REALIZADO CORRECTAMENTE EL PAGO DE 
					<!-- <?php echo $_SESSION["precio"]; unset($_SESSION["precio"]);?>  -->
					100.0€
				</h1> 
				<h2 class="display-8 text-white pt-2">EN BREVE MOMENTOS TE ENVIAREMOS UN CORREO</h2>
