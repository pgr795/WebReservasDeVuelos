...
<html>
	<head>
		...
		<style type="text/css">
			...
			/* Evitar que el contenido empuje el footer fuera de la vista */
			.content-wrapper {
				flex: 1;
				width: 100%;
			}
	...
	<body>
		<div class="container py-5" style="font-family: Arial, Helvetica, sans-serif;">
			<div class="card border-light text-white text-center px-4 py-4 my-4" style="background:rgba(0,0,0,0.8);font-weight: bold;">
				...
				<h2 class="display-8 text-white pt-2">MENÚ PASAJERO - CONSULTAR RESERVA </h2>
				...
				<div class="card-body" style="text-align: center;">
					<div class="btn-group w-100 pt-2" role="group" style="text-align: center; font-size: medium;">
						<input type='button' value="Consultar Reserva" onclick="window.location.href='.php'" class="w-50 btn btn-outline-light">
						<input type="button" value="Atras" onclick="window.location.href='Menu_Pasajero_controllers.php'" class="w-50 btn btn-outline-light">
					</div>	
				</div>
			</div>
		</div>
