	...
	<body>
		<div class="container py-5" style="font-family: Arial, Helvetica, sans-serif;">
			<div class="card border-light text-white text-center px-4 py-4 my-4" style="background:rgba(0,0,0,0.8);font-weight: bold;">
				...
				<h2 class="display-8 text-white pt-2">MENÚ PASAJERO - CANCELAR RESERVA </h2>
				<div class="card-body" style="text-align: left;">
					<p class="text-white pt-2">Origen:</p>
					<!-- <?php echo $_SESSION['nombre']; ?> <BR><BR> -->
					<p class="text-white pt-2">Destino:</p>
					<!-- <?php echo $_SESSION['email']; ?>  <BR><BR> -->
					<p class="text-white pt-2">Ciudad de Origen:</p>
					<!-- <?php echo $_SESSION['nombre']; ?> <BR><BR> -->
					<p class="text-white pt-2">Ciudad de Destino:</p>
					<!-- <?php echo $_SESSION['email']; ?>  <BR><BR> -->
					<p class="text-white pt-2">Fecha del Embarque:</p>
					<!-- <?php echo $_SESSION['nombre']; ?> <BR><BR> -->
				</div>	
				<div class="card-body" style="text-align: center;">
					<div class="btn-group w-100 pt-2" role="group" style="text-align: center; font-size: medium; font-weight: bold;">
						<input type='button' value="Cancelar Reserva" onclick="window.location.href='.php'" class="w-50 btn btn-outline-light btn-lg">
